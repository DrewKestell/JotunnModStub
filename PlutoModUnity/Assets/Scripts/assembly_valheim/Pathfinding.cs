...
public class Pathfinding : MonoBehaviour
{
	...
	private void SetupAgents()
	{
		...
		AgentSettings agentSettings4 = AddAgent(AgentType.Abomination);
		agentSettings4.m_build.agentHeight = 5f;
		agentSettings4.m_build.agentClimb = 0.6f;
		agentSettings4.m_build.agentRadius = 1.5f;
		agentSettings4.m_build.agentSlope = 85f;
		AgentSettings agentSettings5 = AddAgent(AgentType.GoblinBruteSize);
		agentSettings5.m_build.agentHeight = 3.5f;
		agentSettings5.m_build.agentClimb = 0.3f;
		agentSettings5.m_build.agentRadius = 0.8f;
		agentSettings5.m_build.agentSlope = 85f;
		AgentSettings agentSettings6 = AddAgent(AgentType.HugeSize);
		agentSettings6.m_build.agentHeight = 10f;
		agentSettings6.m_build.agentClimb = 0.6f;
		agentSettings6.m_build.agentRadius = 2f;
		agentSettings6.m_build.agentSlope = 85f;
		AgentSettings agentSettings7 = AddAgent(AgentType.HorseSize);
		agentSettings7.m_build.agentHeight = 2.5f;
		agentSettings7.m_build.agentClimb = 0.3f;
		agentSettings7.m_build.agentRadius = 0.8f;
		agentSettings7.m_build.agentSlope = 85f;
		AgentSettings agentSettings8 = AddAgent(AgentType.Fish);
		agentSettings8.m_build.agentHeight = 0.5f;
		agentSettings8.m_build.agentClimb = 1f;
		agentSettings8.m_build.agentRadius = 0.5f;
		agentSettings8.m_build.agentSlope = 90f;
		agentSettings8.m_canSwim = true;
		agentSettings8.m_canWalk = false;
		agentSettings8.m_swimDepth = 0.4f;
		agentSettings8.m_areaMask = 12;
		AgentSettings agentSettings9 = AddAgent(AgentType.BigFish);
		agentSettings9.m_build.agentHeight = 1.5f;
		agentSettings9.m_build.agentClimb = 1f;
		agentSettings9.m_build.agentRadius = 1f;
		agentSettings9.m_build.agentSlope = 90f;
		agentSettings9.m_canSwim = true;
		agentSettings9.m_canWalk = false;
		agentSettings9.m_swimDepth = 1.5f;
		agentSettings9.m_areaMask = 12;
