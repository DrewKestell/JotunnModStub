...
public class CharacterAnimEvent : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		if (!(m_character == null) && m_nview.IsValid())
		{
			...
			UpdateFreezeFrame(Time.fixedDeltaTime);
		}
	}
	...
	private void UpdateFootIK()
	{
		...
		if ((m_character.IsFlying() && !m_character.IsOnGround()) || (m_character.IsSwiming() && !m_character.IsOnGround()) || m_character.IsSitting())
		{
