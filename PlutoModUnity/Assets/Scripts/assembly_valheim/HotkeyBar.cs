...
public class HotkeyBar : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if ((bool)localPlayer && !InventoryGui.IsVisible() && !Menu.IsVisible() && !GameCamera.InFreeFly() && !Minimap.IsOpen())
		{
			...
			if (ZInput.GetButtonDown("JoyDPadUp") && !ZInput.GetButton("JoyLTrigger"))
			{
