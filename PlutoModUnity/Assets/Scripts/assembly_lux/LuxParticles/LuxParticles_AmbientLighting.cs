...
namespace LuxParticles
{
	...
	public class LuxParticles_AmbientLighting : MonoBehaviour
	{
		...
		private const float k1 = 0.488602519f;

		private const float k2 = 1.09254849f;

		private const float k3 = 0.31539157f;

		private const float k4 = 0.546274245f;

		private static float[] ks = new float[9] { 0.2820948f, -0.488602519f, 0.488602519f, -0.488602519f, 1.09254849f, -1.09254849f, 0.31539157f, -1.09254849f, 0.546274245f };
